...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/login?message=' + encodeURIComponent('Registered successfully! Please login.'));
    } catch (err) {
    ...
    <div className="flex h-screen items-center justify-center bg-[#FAFAFA]">
      <div className="w-full max-w-md p-8 bg-white rounded-3xl shadow-xl border border-gray-100">
        ...
        <p className="mt-6 text-center text-gray-600">
          ...
          <Link to="/login" className="text-black font-bold hover:underline decoration-[#FFC629] decoration-2 underline-offset-2">
            Login
          </Link>
        </p>
      </div>
