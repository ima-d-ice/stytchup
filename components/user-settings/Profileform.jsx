      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea name="bio" rows={4} value={formData.bio} onChange={onChange} placeholder="Tell us about your style..." className="w-full border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:border-yellow-400 focus:ring-yellow-400 transition-colors bg-gray-50 resize-none outline-none"/>
          </div>
...
function InputGroup({ label, name, value, onChange, placeholder }) {
    return (<div>
      ...
      <input type="text" name={name} value={value} onChange={onChange} placeholder={placeholder} className="w-full border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:border-yellow-400 focus:ring-yellow-400 transition-colors bg-gray-50 outline-none"/>
    </div>);
}
