...
export default function ContactButton({ designerId, designerName }) {
    ...
    return (<button onClick={handleContact} disabled={loading} className="flex w-full items-center justify-center rounded-2xl bg-black px-8 py-4 text-lg font-bold text-white shadow-lg transition-all duration-300 hover:bg-gray-800 hover:scale-[1.02] disabled:opacity-50">
