...
const Testimonials = () => {
    ...
    return (<section className="py-20 bg-[#FFFBEB]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-2 max-w-5xl mx-auto">
          {testimonials.map((testimonial, index) => (<div key={index} className="relative p-8 bg-white rounded-4xl shadow-sm border border-yellow-100 hover:shadow-md transition-shadow">
              {/* Quote Icon */}
              ...
              <div className="flex items-center border-t border-gray-100 pt-6">
                <div className="relative w-14 h-14 mr-4">
                  <Image src={testimonial.avatar} alt={testimonial.name} fill className="rounded-full object-cover ring-2 ring-gray-100"/>
                </div>
                <div>
