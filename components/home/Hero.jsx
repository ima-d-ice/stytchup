...
const Hero = () => {
    return (<section className="relative overflow-hidden bg-[#FFC629] text-gray-900">
      ...
      <div className="relative container mx-auto flex flex-col items-center px-4 py-24 text-center md:py-36 lg:px-32">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link href="/designs" className="px-10 py-4 text-lg font-bold bg-gray-900 text-white rounded-full shadow-lg hover:bg-gray-800 hover:scale-105 transition-all duration-300">
            Explore Designs
          </Link>
          <Link href="/designer" className="px-10 py-4 text-lg font-bold bg-white text-gray-900 border-2 border-white rounded-full shadow-md hover:bg-gray-50 hover:text-[#FFC629] hover:scale-105 transition-all duration-300">
            Become a Designer
          </Link>
        </div>
      </div>
